...
namespace Netus2_DatabaseConnection.daoImplementations
{
    public class JctClassPersonDaoImpl : IJctClassPersonDao
    {
        ...
        {
            DataTable dtJctClassPerson = new DataTableFactory().Dt_Netus2_JctClassPerson;
            dtJctClassPerson = connection.ReadIntoDataTable(sql, dtJctClassPerson).Result;
        ...
        public DataRow Write(int classId, int personId, int roleId, IConnectable connection)
        {
            ...
            DataRow jctClassPersonDao = new DataTableFactory().Dt_Netus2_JctClassPerson.NewRow();

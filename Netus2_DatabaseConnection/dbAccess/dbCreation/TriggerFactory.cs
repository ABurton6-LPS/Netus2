    ...
    public class TriggerFactory
    {
        ...
        private static void BuildEnumTrueFalse_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code = 'update') "
                + "FROM deleted d "
                + "END";
        ...
        private static void BuildEnumTrueFalse_DeleteTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_true_false_id, netus2_code, sis_code, hr_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_true_false_id, d.netus2_code, d.sis_code, d.hr_code, d.descript, dbo.CURRENT_DATETIME(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code = 'delete') "
                + "FROM deleted d "
                + "END";
        ...
        private static void BuildPerson_UpdateTrigger(IConnectable connection)
        {
            ...
            + "dbo.CURRENT_DATETIME(), SUSER_SNAME(), (SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code = 'update') "
            + "FROM deleted d "
            + "END";
        ...
        private static void BuildJctEnrollmentAcademicSession_UpdateTrigger(IConnectable connection)
        {
            ...
            + "dbo.CURRENT_DATETIME(), SUSER_SNAME(), (SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code = 'delete') "
            + "FROM deleted d "
            + "END";

    ...
    public class TriggerFactory
    {
        ...
        private static void BuildEnumLogAction_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_log_action_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user) "
                + "SELECT d.enum_log_action_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME() "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumTrueFalse_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_true_false_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_true_false_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
        ...
        private static void BuildEnumPhone_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_phone_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_phone_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumAddress_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_address_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_address_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumClass_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_class_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_class_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumGender_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_gender_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_gender_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumImportance_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_importance_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_importance_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumOrganization_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_organization_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_organization_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumRole_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_role_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id)"
                + "SELECT d.enum_role_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumScoreStatus_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_score_status_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_score_status_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumSession_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_session_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_session_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumResidenceStatus_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_residence_status_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_residence_status_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumCountry_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_country_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_country_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumStateProvince_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_state_province_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_state_province_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumGrade_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_grade_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_grade_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumSubject_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_subject_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_subject_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumPeriod_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_period_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_period_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumCategory_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_category_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_category_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumEthnic_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_ethnic_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_ethnic_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuildEnumIdentifier_UpdateTrigger(IConnectable connection)
        {
            string sql =
                ...
                + "(enum_identifier_id, netus2_code, sis_code, hr_code, pip_code, descript, log_date, log_user, enum_log_action_id) "
                + "SELECT d.enum_identifier_id, d.netus2_code, d.sis_code, d.hr_code, d.pip_code, d.descript, GETDATE(), SUSER_SNAME(), "
                + "(SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
                + "FROM inserted d "
                + "END";
        ...
        private static void BuilldAcademicSession_UpdateTrigger(IConnectable connection)
        {
            ...
            + "(academic_session_id, name, start_date, end_date, enum_session_id, parent_session_id, organization_id, "
            + "created, created_by, changed, changed_by, log_date, log_user, enum_log_action_id) "
            + "SELECT d.academic_session_id, d.name,d.start_date,d.end_date,d.enum_session_id,d.parent_session_id,d.organization_id, "
            + "d.created, d.created_by, d.changed, d.changed_by,"
            + "GETDATE(), SUSER_SNAME(), (SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
            + "FROM inserted d "
            + "END";
        ...
        private static void BuildOrganization_UpdateTrigger(IConnectable connection)
        {
            ...
            + "(organization_id, name, enum_organization_id, identifier, building_code, organization_parent_id, "
            + "created, created_by, changed, changed_by, "
            + "log_date, log_user, enum_log_action_id) "
            + "SELECT d.organization_id, d.name, d.enum_organization_id, d.identifier, d.building_code, d.organization_parent_id, "
            + "d.created, d.created_by, d.changed, d.changed_by, "
            + "GETDATE(), SUSER_SNAME(), (SELECT enum_log_action_id FROM enum_log_action WHERE netus2_code LIKE 'update') "
            + "FROM inserted d "
            + "END";

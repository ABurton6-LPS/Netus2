...
namespace Netus2_Test.Unit.SyncProcess
{
    public class SyncAddress_Test
    {
        ...
        public void SisRead_Address_TestData()
        {
            ...
            Assert.AreEqual(emptyString, results.Rows[1]["address_line_2"].ToString());
        ...
        public void SyncAddress_ShouldWriteNewRecord()
        {
            ...
            Assert.IsTrue(mockJctPersonAddressDaoImpl.WasCalled_WriteTempTable);
            Assert.IsFalse(mockAddressDaoImpl.WasCalled_Update);
        }

        [TestCase]
        public void SyncAddress_ShouldOnlyWriteNewJctRecord()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            ...
            tstData.IsPrimary = addressTeacher.IsPrimary.Netus2Code;
            tstData.AddressType = addressTeacher.AddressType.Netus2Code;
            tstData.PersonId = tdBuilder.student.UniqueIdentifiers[0].Identifier;
        ...
        public void SyncAddress_ShouldNeitherUpdateNorWriteRecord()
        {
            ...
            Assert.IsFalse(mockJctPersonAddressDaoImpl.WasCalled_WriteTempTable);
            Assert.IsFalse(mockAddressDaoImpl.WasCalled_Update);
        }

        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentLine1()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentLine2()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentLine3()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentLine4()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentApartment()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentCity()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentState()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentCountry()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentIsPrimary()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;
        ...
        [TestCase]
        public void SyncAddress_ShouldWriteNewRecord_DifferentAddressType()
        {
            mockPersonDaoImpl._shouldReadReturnData = true;
            mockAddressDaoImpl._shouldReadReturnData = true;

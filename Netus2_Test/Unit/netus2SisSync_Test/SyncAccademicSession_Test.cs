...
namespace Netus2_Test.Unit.netus2SisSync_Test
{
    public class SyncAccademicSession_Test
    {
        ...
        {
            SisAcademicSessionTestData tstData = new SisAcademicSessionTestData();
            tstData.SessionCode = tdBuilder.school.BuildingCode + "-" + tdBuilder.semester1.TermCode + "-" + tdBuilder.semester1.SchoolYear;
            ...
            tstData.OrgId = tdBuilder.district.BuildingCode;

            SisAcademicSessionTestData tstData2 = new SisAcademicSessionTestData();
            tstData2.SessionCode = tdBuilder.school.BuildingCode + "-" + tdBuilder.semester2.TermCode + "-" + tdBuilder.semester2.SchoolYear;
            ...
            tstData2.OrgId = tdBuilder.district.BuildingCode;
            ...
            Assert.NotNull(results);
            Assert.AreEqual(tstDataSet.Count, results.Rows.Count);
            Assert.AreEqual(tstDataSet[0].SessionCode, results.Rows[0]["session_code"].ToString());
            ...
            Assert.AreEqual(tstDataSet[0].OrgId, results.Rows[0]["organization_id"].ToString());

            Assert.NotNull(results);
            Assert.AreEqual(tstDataSet.Count, results.Rows.Count);
            Assert.AreEqual(tstDataSet[1].SessionCode, results.Rows[1]["session_code"].ToString());
            ...
            Assert.AreEqual(tstDataSet[1].OrgId, results.Rows[1]["organization_id"].ToString());
        }
        ...
        {
            SisAcademicSessionTestData tstData = new SisAcademicSessionTestData();
            tstData.SessionCode = tdBuilder.school.BuildingCode + "-" + tdBuilder.schoolYear.TermCode + "-" + tdBuilder.schoolYear.SchoolYear;
            ...
            new SyncTask_AcademicSessionChildRecords("TestTask", DateTime.Now, 
                new SyncJob_AcademicSession("TestJob", DateTime.Now, _sisConnection, _netus2DbConnection))
                .Execute(row, _latch);
        ...
        public void SyncParent_AcademicSession()
        {
            ...
            SyncTask_AcademicSessionParentRecords syncTask_AcademicSessionParentRecords =
                new SyncTask_AcademicSessionParentRecords("TestTask", DateTime.Now, syncJob_AcademicSession);

            syncTask_AcademicSessionParentRecords.Execute(row, _latch);
        ...
        private DataTable BuildTestDataTable(List<SisAcademicSessionTestData> tstDataSet)
        {
            ...
            foreach(SisAcademicSessionTestData tstData in tstDataSet)
            {
                ...
                row["session_code"] = tstData.SessionCode;
                ...
                row["organization_id"] = tstData.OrgId;

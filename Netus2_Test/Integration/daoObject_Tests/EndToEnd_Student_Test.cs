...
namespace Netus2_Test.Integration
{
    class EndToEnd_StudentTest
    {
        ...
        public void GivenStudent_WithRelevantData_ShouldReadAndWriteToAllAppropriateTables()
        {
            ...
            Assert_Table(person.Id, 1, "person", DataTableFactory.Dt_Netus2_Person, connection);
            Assert_Table(person.Id, 1, "jct_person_role", DataTableFactory.Dt_Netus2_JctPersonRole, connection);
            Assert_Table(person.PhoneNumbers[0].Id, 1, "phone_number", DataTableFactory.Dt_Netus2_PhoneNumber, connection);
            Assert_Table(person.Addresses[0].Id, 1, "address", DataTableFactory.Dt_Netus2_Address, connection);
            Assert_Table(person.UniqueIdentifiers[0].Id, 1, "unique_identifier", DataTableFactory.Dt_Netus2_UniqueIdentifier, connection);
            Assert_Table(person.Marks[0].Id, 1, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
            Assert_Table(person.Marks[0].LineItem.Id, 1, "lineitem", DataTableFactory.Dt_Netus2_LineItem, connection);
            Assert_Table(person.Enrollments[0].Id, 1, "enrollment", DataTableFactory.Dt_Netus2_Enrollment, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "class", DataTableFactory.Dt_Netus2_ClassEnrolled, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_period", DataTableFactory.Dt_Netus2_JctClassPeriod, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_resource", DataTableFactory.Dt_Netus2_JctClassResource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Resources[0].Id, 1, "resource", DataTableFactory.Dt_Netus2_Resource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "course", DataTableFactory.Dt_Netus2_Course, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_subject", DataTableFactory.Dt_Netus2_JctCourseSubject, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_grade", DataTableFactory.Dt_Netus2_JctCourseGrade, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Id, 1, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Organization.Id, 1, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
        ...
        public void GivenStudent_WhenStudentIsDeleted_ShouldDeleteAllRelatedRecords()
        {
            ...
            Assert_Table(person.Id, 0, "person", DataTableFactory.Dt_Netus2_Person, connection);
            Assert_Table(person.Id, 0, "jct_person_role", DataTableFactory.Dt_Netus2_JctPersonRole, connection);
            Assert_Table(person.PhoneNumbers[0].Id, 0, "phone_number", DataTableFactory.Dt_Netus2_PhoneNumber, connection);
            Assert_Table(person.Addresses[0].Id, 1, "address", DataTableFactory.Dt_Netus2_Address, connection);
            Assert_Table(person.UniqueIdentifiers[0].Id, 0, "unique_identifier", DataTableFactory.Dt_Netus2_UniqueIdentifier, connection);
            Assert_Table(person.Marks[0].Id, 0, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
            Assert_Table(person.Marks[0].LineItem.Id, 1, "lineitem", DataTableFactory.Dt_Netus2_LineItem, connection);
            Assert_Table(person.Enrollments[0].Id, 0, "enrollment", DataTableFactory.Dt_Netus2_Enrollment, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "class", DataTableFactory.Dt_Netus2_ClassEnrolled, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_person", DataTableFactory.Dt_Netus2_JctClassPerson, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_period", DataTableFactory.Dt_Netus2_JctClassPeriod, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_resource", DataTableFactory.Dt_Netus2_JctClassResource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Resources[0].Id, 1, "resource", DataTableFactory.Dt_Netus2_Resource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "course", DataTableFactory.Dt_Netus2_Course, connection);
        ...
        public void GivenStudent_WhenClassIsDeleted_ShouldDeleteAllRelatedRecords()
        {
            ...
            Assert_Table(person.UniqueIdentifiers[0].Id, 1, "unique_identifier", DataTableFactory.Dt_Netus2_UniqueIdentifier, connection);
            Assert_Table(person.Marks[0].Id, 0, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
            Assert_Table(person.Marks[0].LineItem.Id, 0, "lineitem", DataTableFactory.Dt_Netus2_LineItem, connection);
            Assert_Table(person.Enrollments[0].Id, 0, "enrollment", DataTableFactory.Dt_Netus2_Enrollment, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "class", DataTableFactory.Dt_Netus2_ClassEnrolled, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "jct_class_person", DataTableFactory.Dt_Netus2_JctClassPerson, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "jct_class_period", DataTableFactory.Dt_Netus2_JctClassPeriod, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "jct_class_resource", DataTableFactory.Dt_Netus2_JctClassResource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Resources[0].Id, 1, "resource", DataTableFactory.Dt_Netus2_Resource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "course", DataTableFactory.Dt_Netus2_Course, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_subject", DataTableFactory.Dt_Netus2_JctCourseSubject, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_grade", DataTableFactory.Dt_Netus2_JctCourseGrade, connection);
        ...
        public void GivenStudent_WhenResourceIsDeleted_ShouldDeleteAllRelatedRecords()
        {
            ...
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 1, "jct_class_period", DataTableFactory.Dt_Netus2_JctClassPeriod, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "jct_class_resource", DataTableFactory.Dt_Netus2_JctClassResource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Resources[0].Id, 0, "resource", DataTableFactory.Dt_Netus2_Resource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "course", DataTableFactory.Dt_Netus2_Course, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_subject", DataTableFactory.Dt_Netus2_JctCourseSubject, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_grade", DataTableFactory.Dt_Netus2_JctCourseGrade, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Id, 1, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
        ...
        public void GivenStudent_WhenOrganizationIsDeleted_ShouldDeleteAllRelatedRecords()
        {
            ...
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_subject", DataTableFactory.Dt_Netus2_JctCourseSubject, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 1, "jct_course_grade", DataTableFactory.Dt_Netus2_JctCourseGrade, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Id, 0, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Organization.Id, 0, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
        }
        ...
        public void GivenStudent_WhenCourseIsDeleted_ShouldDeleteAllRelatedRecords()
        {
            ...
            Assert_Table(person.Enrollments[0].ClassEnrolled.Id, 0, "jct_class_resource", DataTableFactory.Dt_Netus2_JctClassResource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Resources[0].Id, 1, "resource", DataTableFactory.Dt_Netus2_Resource, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 0, "course", DataTableFactory.Dt_Netus2_Course, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 0, "jct_course_subject", DataTableFactory.Dt_Netus2_JctCourseSubject, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.Course.Id, 0, "jct_course_grade", DataTableFactory.Dt_Netus2_JctCourseGrade, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Id, 1, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert_Table(person.Enrollments[0].ClassEnrolled.AcademicSession.Organization.Id, 1, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
        }
        ...
        public void GivenAcademicSession_WhenChangeOrganization_ShouldUpdateRelevantTables()
        {
            ...
            Assert_Table(result.Id, 1, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert.AreNotEqual(oldOrg.Id, result.Organization.Id);
            Assert_Table(oldOrg.Id, 1, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
            Assert_Table(result.Organization.Id, 1, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
        }
        ...
        public void GivenClassEnrolled_WhenChangeAcademicSession_ShouldUpdateRelevantTables()
        {
            ...
            Assert_Table(result.Id, 1, "class", DataTableFactory.Dt_Netus2_ClassEnrolled, connection);
            Assert.AreNotEqual(oldAcademicSession.Id, result.AcademicSession.Id);
            Assert_Table(oldAcademicSession.Id, 0, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert_Table(result.AcademicSession.Id, 1, "academic_session", DataTableFactory.Dt_Netus2_AcademicSession, connection);
            Assert_Table(result.AcademicSession.Organization.Id, 1, "organization", DataTableFactory.Dt_Netus2_Organization, connection);
        }
        ...
        public void GivenStudentWithMarks_WhenMarkIsDeleted_ShouldUpdateRelevantTables()
        {
            ...
            Assert_Table(mark.Id, 1, "mark", DataTableFactory.Dt_Netus2_Mark, connection);

            markDaoImpl.Delete(mark, person.Id, connection);
            person.Marks.Clear();

            Assert_Table(mark.Id, 0, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
        ...
        public void GivenStudentWithMarks_WhenMarkIsChanged_ShouldUpdateRelevantTables()
        {
            ...
            Assert_Table(mark.Id, 0, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
            Assert_Table(personAfterRead.Marks[0].Id, 1, "mark", DataTableFactory.Dt_Netus2_Mark, connection);
        }
        ...
        public void GivenStudentWithEnrollment_WhenEnrollmentChanges_ShuldReflectInDatabase()
        {
            ...
            Assert_Table(oldEnrollmentId, 0, "enrollment", DataTableFactory.Dt_Netus2_Enrollment, connection);
            Assert_Table(newEnrollmentId, 1, "enrollment", DataTableFactory.Dt_Netus2_Enrollment, connection);
        }

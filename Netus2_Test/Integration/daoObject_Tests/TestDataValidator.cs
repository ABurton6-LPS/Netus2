...
namespace Netus2_Test.Integration
{
    class TestDataValidator
    {
        public static void AssertPerson(Person expected, Person actual, IConnectable connection)
        {
            ...
            Assert_Table(actual.Id, expected.Roles.Count, "jct_person_role", DataTableFactory.CreateDataTable_Netus2_JctPersonRole(), connection);
            ...
            Assert_Table(actual.Id, expected.Relations.Count, "jct_person_person", DataTableFactory.CreateDataTable_Netus2_JctPersonPerson(), connection);
            ...
            {
                Assert_Table(actual.PhoneNumbers[i].Id, expected.PhoneNumbers.Count, "phone_number", DataTableFactory.CreateDataTable_Netus2_PhoneNumber(), connection);
            ...
            {
                Assert_Table(actual.UniqueIdentifiers[i].Id, expected.UniqueIdentifiers.Count, "unique_identifier", DataTableFactory.CreateDataTable_Netus2_UniqueIdentifier(), connection);
            ...
            {
                Assert_Table(actual.Marks[i].Id, expected.Marks.Count, "mark", DataTableFactory.CreateDataTable_Netus2_Mark(), connection);
            ...
            {
                Assert_Table(actual.Enrollments[i].Id, expected.Enrollments.Count, "enrollment", DataTableFactory.CreateDataTable_Netus2_Enrollment(), connection);
            ...
            {
                Assert_Table(actual.EmploymentSessions[i].Id, expected.EmploymentSessions.Count, "employment_session", DataTableFactory.CreateDataTable_Netus2_EmploymentSession(), connection);
